...
# À partir de l'exercice 2 mettre en place un explicit wait dans le code.
# Wait explicit agit sur un élément du code
"""
Définir des options pour le driver. Pour chrome, garder
le navigateur ouvert si driver.quit() n'est pas appelée
"""

# Pour lancer un test avec Pytest, la fonction doit commencer par le mot 'TEST'
